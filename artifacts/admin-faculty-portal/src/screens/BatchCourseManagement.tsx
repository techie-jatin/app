...
import { Award, BarChart2, Bell, BookOpen, Calendar, ChevronDown, ChevronRight, ClipboardList, Clock, Edit2, FileText, GraduationCap, HelpCircle, Layers, Link2, Menu, MoreVertical, PlayCircle, Plus, Search, Settings, Trash2, TrendingUp, Upload, Users, X } from "lucide-react";
...
const navItems = [
  { icon: BarChart2, label: "Dashboard", path: "/admin/dashboard" }, { icon: Users, label: "Students", path: "/admin/students" }, { icon: GraduationCap, label: "Faculty", path: "/admin/faculty" },
  { icon: Layers, label: "Batches", active: true, path: "/admin/batches" }, { icon: BookOpen, label: "Courses", path: "/admin/courses" }, { icon: Calendar, label: "Schedule", path: "/admin/live" },
  { icon: Bell, label: "Notifications", path: "/admin/notifications" }, { icon: Award, label: "Certificates", path: "/admin/certificates" }, { icon: BarChart2, label: "Reports", path: "/admin/reports" },
];
