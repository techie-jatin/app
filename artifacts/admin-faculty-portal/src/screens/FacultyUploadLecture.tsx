...
import { AlertCircle, BarChart2, Bell, BookOpen, Calendar, CheckCircle, ChevronDown, FileText, GraduationCap, HelpCircle, LayoutDashboard, Link2, Menu, PlayCircle, Plus, Upload, Users, Video, X } from "lucide-react";
...
const navItems = [
  ...
  { icon: Upload, label: "Upload Lecture", active: true, path: "/faculty/upload" },
