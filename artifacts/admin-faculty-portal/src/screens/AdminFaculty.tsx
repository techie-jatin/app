...
import { Award, BarChart2, Bell, BookOpen, Calendar, CheckCircle, ChevronRight, Clock, Download, Edit2, Filter, GraduationCap, Layers, Mail, Menu, MoreVertical, Phone, PlayCircle, Plus, Search, Settings, Shield, Star, TrendingUp, Users, X } from "lucide-react";
    ...
    <div className="flex h-screen overflow-hidden font-['Poppins'] w-full" style={{ background: BG, color: TEXT }}>
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <button className="md:hidden p-2 rounded-lg mr-2" style={{ background: "rgba(255,255,255,0.05)" }} onClick={() => setMobileOpen(v => !v)}><Menu className="w-5 h-5" style={{ color: "#94A3B8" }} /></button>
          ...
          {/* KPIs */}
          <div className="px-6 py-4 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 flex-shrink-0" style={{ background: "#0D1526" }}>
            {[
