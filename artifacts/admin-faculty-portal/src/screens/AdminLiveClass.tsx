...
import { Activity, AlertCircle, Award, BarChart2, Bell, BookOpen, Calendar, ChevronDown, Circle, Eye, GraduationCap, Hand, Layers, Menu, MessageCircle, Mic, MicOff, PhoneOff, Pin, Send, Settings, Shield, StopCircle, TrendingUp, UserX, Users, Video, VideoOff, Wifi, X } from "lucide-react";
