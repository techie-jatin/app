                ...
                return (
                  <div key={q.id} onClick={() => setSelected(q.id)} className="p-4 cursor-pointer hover:bg-white/[0.02] transition"
                    ...
                    <div className="flex items-center gap-3 text-xs" style={{ color: MUTED }}>
                      <span className="flex items-center gap-1"><HelpCircle className="w-3 h-3" />{q.totalQuestions}Q</span>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm mt-0.5" style={{ color: MUTED }}>
                    {selBatch?.name || "—"} · {sel.totalQuestions} questions · {sel.timeLimit} min
                  </p>
                </div>
                ...
                <div className="grid grid-cols-4 gap-3">
                  {[
                    ...
                    { label: "Time Limit", value: `${sel.timeLimit}m`, color: "#8B5CF6" },
                  ].map(s => (
