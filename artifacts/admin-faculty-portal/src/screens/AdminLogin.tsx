...
import { AlertTriangle, ChevronRight, Eye, Lock, Mail, Menu, Shield, X } from "lucide-react";
...
export function AdminLogin() {
  ...
  return (
    <div className="w-full min-h-screen flex overflow-hidden font-['Inter']" style={{ background: BG }}>
      ...
      <div className="hidden md:flex md:w-[480px] md:flex-shrink-0 flex-col justify-between p-12 relative overflow-hidden"
