...
import { AlertCircle, BarChart2, Bell, BookOpen, Calendar, CheckCircle, ChevronDown, Clock, FileText, GraduationCap, HelpCircle, LayoutDashboard, Link2, Menu, PlayCircle, Radio, Upload, Users, Video, X } from "lucide-react";
...
const navItems = [
  ...
  { icon: Video, label: "Live Session", active: true, path: "/faculty/live" },
