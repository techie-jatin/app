...
import { BarChart2, Bell, BookOpen, Calendar, CheckCircle, ChevronDown, Circle, Clock, FileText, GraduationCap, HelpCircle, LayoutDashboard, Menu, Paperclip, Plus, Upload, Users, Video, X } from "lucide-react";
...
const navItems = [
  ...
  { icon: FileText, label: "Assignments", active: true, path: "/faculty/assignment" },
