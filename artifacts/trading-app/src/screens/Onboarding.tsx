          ...
          {[55, 75, 45, 90, 62, 85, 70, 95, 60, 88, 72, 100].map((h, i) => {
            ...
            return (
              <div key={i} className="flex-1 flex flex-col items-center gap-1">
                <div className="w-0.5 mx-auto" style={{ height: 12, background: color, opacity: 0.5 }} />
                <div className="w-full rounded-sm" style={{ height: `${h * 0.8}px`, background: color, opacity: isGreen ? 0.9 : 0.7 }} />
                <div className="w-0.5 mx-auto" style={{ height: 8, background: color, opacity: 0.5 }} />
              </div>
            );
          })}
        </div>
      ...
      <div className="flex-1 flex flex-col px-8 relative z-10">
        ...
        <div className="space-y-3 pb-8">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-4 rounded-2xl text-white font-bold text-base shadow-xl"
