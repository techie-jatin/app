import {
  ...
  Search, Filter, CheckCircle, Clock, AlertCircle, X,
  Eye, Download, MessageSquare, Star, FileText, Send,
              ...
              <div className="flex-1 p-5" style={{ background: "#0D1526" }}>
                <div className="max-w-xl mx-auto rounded-2xl overflow-hidden" style={{ background: CARD, border: `1px solid ${BORDER2}` }}>
                  ...
                  <div className="px-6 py-4 flex items-center justify-between" style={{ background: SURFACE, borderBottom: `1px solid ${BORDER2}` }}>
                    ...
                    <div className="flex items-center gap-2">
                      <button className="w-7 h-7 rounded flex items-center justify-center" style={{ background: BORDER2 }}><ChevronLeft className="w-4 h-4" style={{ color: MUTED }} /></button>
                  ...
                  <div className="p-6 space-y-4">
                    ...
                    <div className="rounded-xl overflow-hidden" style={{ border: `1px solid ${BORDER2}` }}>
                      <div className="grid grid-cols-4 px-3 py-2" style={{ background: SURFACE }}>
                      ...
                      {[
                        ...
                        <div key={i} className="grid grid-cols-4 px-3 py-2" style={{ borderTop: `1px solid ${BORDER2}` }}>
                          {row.map((cell, j) => (
